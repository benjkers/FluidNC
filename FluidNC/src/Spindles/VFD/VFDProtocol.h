...
namespace Spindles {
    ...
    namespace VFD {
        ...
        protected:
            ...
            // CumarkProtocol::direction_command() queuing a restart action
            // after a direction change, since only one Modbus transaction
            // can be built per callback invocation).
