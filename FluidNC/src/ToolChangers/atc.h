...
namespace ATCs {
    ...
    public:
        ...
        virtual bool tool_change(tool_t value, bool pre_select, bool set_tool, bool master_gauge = false, bool has_manual_gauge = false,
                                  float manual_gauge_value = 0.0f) = 0;
